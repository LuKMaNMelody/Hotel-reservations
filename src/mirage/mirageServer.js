  ...
  let server = createServer({
    ...
    routes() {
              ...
              elements: [
                {
                  code: 1211,
                  name: 'Astana',
                  imageUrl: '/images/cities/Astana1.jpg',
                },
                {
                  code: 1212,
                  name: 'Astana',
                  imageUrl: '/images/cities/Astana2.jpg',
                },
                {
                  code: 1213,
                  name: 'Astana',
                  imageUrl: '/images/cities/Astana3.jpg',
                },
                {
                  code: 1214,
                  name: 'Almaty',
                  imageUrl: '/images/cities/Almaty1.jpg',
                },
                {
                  code: 1215,
                  name: 'Almaty',
                  imageUrl: '/images/cities/Almaty2.jpg',
                },
              ],
            },
          }
      ...
      this.get('/hotel/:hotelId', (_schema, request) => {
        let hotelId = request.params.hotelId;
        const description = [
          'Сән-салтанат пен жайлылықтың үйлесімін ұсынатын, жоғары деңгейдегі ыңғайлылықтарды ұсынатын керемет қонақ үйімізде тыныш демалыс күтеді.',
          'Қаланың ғажайып көріністері бар әдемі безендірілген бөлмелерімізде талғампаздықтың шыңын сезініңіз.',
          'Жергілікті және халықаралық тағамдардан тұратын мейрамханаларымызда гастрономиялық ләззат алыңыз.',
          'Біздің заманауи СПА-сауықтыру орталығында демалыңыз, бұл сезімдер үшін тамаша демалыс орны.',
          'Қаланың қақ ортасында орналасқан біздің қонақ үйіміз демалу үшін де, іскер саяхатшылар үшін де тамаша база болып табылады.',
        ];
