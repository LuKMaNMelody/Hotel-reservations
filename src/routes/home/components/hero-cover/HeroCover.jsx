      ...
      <div className="hero-content__container flex flex-col items-center container mx-auto px-2 md:px-0">
        ...
        <div className="hero-content__text py-4">
          <h3 className="text-4xl font-medium">
            Әлемнің кез келген жерінен тамаша демалыс орнын табыңыз
          </h3>
          <p className="my-1">
            Ағымдағы бағаларды көру және демалу мен шытырман оқиғаға саяхатыңызды бүгін бастау үшін күндеріңізді енгізіңіз.
          </p>
        </div>
        <GlobalSearchBox
