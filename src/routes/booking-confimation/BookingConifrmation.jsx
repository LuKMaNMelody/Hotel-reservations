  ...
  return (
    <div className="md:mx-auto max-w-[800px] my-40">
      ...
      >
        ...
        <h1 className="text-gray-700 text-2xl font-bold">Брондау расталды</h1>
        <p className="text-gray-600 mt-2">
          Брондағаныңыз үшін рахмет! Брондауыңыз расталды.
        </p>
        <p className="text-gray-600">
          Брондау мәліметтері мен болу нұсқаулығы үшін электрондық поштаңызды тексеріңіз.
        </p>
