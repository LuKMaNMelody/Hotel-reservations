            ...
            <div className="bg-white p-6  md:mx-auto">
              ...
              <div className="text-center">
                <h3 className="md:text-2xl text-base text-gray-700 font-semibold text-center">
                  Қалпына келтіру электрондық поштасы жіберілді!
                </h3>
                <p className="text-green-500">
                  {' '}
                  Спамыңызды тексеруді ұмытпаңыз{' '}
                </p>
            ...
            >
              <div className="text-center mb-10">
                <h2 className="text-3xl font-extrabold text-brand my-4">
                  Құпия сөзіңізді қалпына келтіріңіз
                </h2>
                <div className="mb-6">
                  <input
                    type="email"
                  ...
                  <p className="text-gray-700">
                    Сәйкес келсе, растау кодын осы электрондық поштаға жібереміз
                    бар тіркелгі.
                  </p>
                </div>
                {errorMessage && (
